...
import com.ruseps.net.packet.impl.ButtonClickPacketListener;
import com.ruseps.net.packet.impl.ChangeAppearancePacketListener;
import com.ruseps.net.packet.impl.ChangeRelationStatusPacketListener;
import com.ruseps.net.packet.impl.ChatPacketListener;
import com.ruseps.net.packet.impl.ClickTextMenuPacketListener;
import com.ruseps.net.packet.impl.CloseInterfacePacketListener;
import com.ruseps.net.packet.impl.CommandPacketListener;
import com.ruseps.net.packet.impl.DialoguePacketListener;
import com.ruseps.net.packet.impl.DropItemPacketListener;
import com.ruseps.net.packet.impl.DuelAcceptancePacketListener;
import com.ruseps.net.packet.impl.DungeoneeringPartyInvitatationPacketListener;
import com.ruseps.net.packet.impl.EnterInputPacketListener;
import com.ruseps.net.packet.impl.EquipPacketListener;
import com.ruseps.net.packet.impl.ExamineItemPacketListener;
import com.ruseps.net.packet.impl.ExamineNpcPacketListener;
import com.ruseps.net.packet.impl.FinalizedMapRegionChangePacketListener;
import com.ruseps.net.packet.impl.FollowPlayerPacketListener;
import com.ruseps.net.packet.impl.GESelectItemPacketListener;
import com.ruseps.net.packet.impl.HeightCheckPacketListener;
import com.ruseps.net.packet.impl.IdleLogoutPacketListener;
import com.ruseps.net.packet.impl.ItemActionPacketListener;
import com.ruseps.net.packet.impl.ItemContainerActionPacketListener;
import com.ruseps.net.packet.impl.MagicOnItemsPacketListener;
import com.ruseps.net.packet.impl.MagicOnPlayerPacketListener;
import com.ruseps.net.packet.impl.MovementPacketListener;
import com.ruseps.net.packet.impl.NPCOptionPacketListener;
import com.ruseps.net.packet.impl.ObjectActionPacketListener;
import com.ruseps.net.packet.impl.PickupItemPacketListener;
import com.ruseps.net.packet.impl.PlayerOptionPacketListener;
import com.ruseps.net.packet.impl.PlayerRelationPacketListener;
import com.ruseps.net.packet.impl.PrestigeSkillPacketListener;
import com.ruseps.net.packet.impl.RegionChangePacketListener;
import com.ruseps.net.packet.impl.SendClanChatMessagePacketListener;
import com.ruseps.net.packet.impl.SilencedPacketListener;
import com.ruseps.net.packet.impl.SwitchItemSlotPacketListener;
import com.ruseps.net.packet.impl.TradeInvitationPacketListener;
import com.ruseps.net.packet.impl.UseItemPacketListener;
import com.ruseps.net.packet.impl.WithdrawMoneyFromPouchPacketListener;
