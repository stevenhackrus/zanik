...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case 11014:
			...
			break;
		case -26333:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/forum/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/forum");
			break;
		case -26332:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/rules/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/rules");
			break;
		case -26331:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/store/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/store");
			break;
		case -26330:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/vote/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/vote");
			break;
		case -26329:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/hiscores/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/hiscores");
			break;
		case -26328:
			player.getPacketSender().sendString(1, "www.ruse-ps.com/report/");
			player.getPacketSender().sendMessage("Attempting to open: Ruse-Ps.com/report");
			break;
		case -26337:
