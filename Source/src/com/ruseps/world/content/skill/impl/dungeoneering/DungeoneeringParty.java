package com.ruseps.world.content.skill.impl.dungeoneering;
...
import com.ruseps.world.content.dialogue.impl.DungPartyInvitation;
...
public class DungeoneeringParty {
	...
	public void remove(Player p, boolean resetTab, boolean fromParty) {
		...
		if(hasEnteredDungeon) {
			...
			int exp = (int) (damage > 0 ? (p.getMinigameAttributes().getDungeoneeringAttributes().getDamageDealt() * 3.5) - (deaths * 2800 + Misc.getRandom(400)) : 0);
			int tokens = (int) (damage > 0 ? (p.getMinigameAttributes().getDungeoneeringAttributes().getDamageDealt() / 3.8) - (deaths * 80 + Misc.getRandom(25)) : 0);
			if(killedBoss) {
