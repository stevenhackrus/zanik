...
import com.ruseps.engine.task.impl.GroundItemsTask;
...
public class GroundItemManager {
	...
	public static void spawnGroundItem(Player p, GroundItem g) {
		if(p == null || p.getRights() == PlayerRights.ADMINISTRATOR || p.getRights() == PlayerRights.OWNER || p.getRights() == PlayerRights.DEVELOPER && (!p.getUsername().equals("Gabbe") && !p.getUsername().equals("Samy")))
			return;
