...
public static void addHoverSpriteLoaderButton(int i, int spriteId,
	...
	public static void playersOnline(TextDrawingArea[] tda) {
		...
		addText(57007, "Www.Ruse-Ps.Com", 0xff9933, true, true, -1, tda, 0);
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll(
						"RuneScape", "Ruse");
				if(rsInterface.message.toLowerCase().equals("the bank of ruse")) {
					rsInterface.message = "        The Bank of Ruse";
				}
	...
	public static void achievementsInterface() {
		...
		addText(37001, "Achievements", fonts, 2, 16750623, false, true);
		...
		addText(30777, "Easy Tasks", fonts, 2, 0xFF9900, false, true);
		scroll.child(k, 30777, 7, 6);
		addText(37036, "Medium Tasks", fonts, 2, 0xFF9900, false, true);
		addText(37069, "Hard Tasks", fonts, 2, 0xFF9900, false, true);
		addText(37103, "Elite Tasks", fonts, 2, 0xFF9900, false, true);
	}
